...
class Task5:
    ...
    def read_all_links(self, linkpath):
        links =pd.read_csv(linkpath, index_col=None, header=None, sep = '\t').values
        return links
...
if __name__ == '__main__':
    ...
    urllist = [
        # 'https://www.planning2.cityoflondon.gov.uk/online-applications/search.do?action=advanced',
    ...
    councillist = [
        ...
        # 'London_Borough_of_Croydon', # can not connected
    ...
    for i in range(0, len(urllist)):        
        try: 
            infoPageName = datapath + councillist[i] + '1.xlsx'
